  ...
  return (
    <AppShell>
      <section style={{ maxWidth: 1180, margin: '0 auto', padding: '56px 20px' }}>
        <p style={{ textTransform: 'uppercase', fontSize: 12, fontWeight: 800, color: '#059669', letterSpacing: '0.16em' }}>
          Provider Operating System
        </p>
        <h1 style={{ fontSize: 'clamp(32px, 5vw, 64px)', letterSpacing: '-0.05em', margin: '12px 0' }}>
          Manage bookings, inventory, staff, fleet, pricing, payouts, and growth.
        </h1>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 16, marginTop: 32 }}>
          {['Booking command center', 'Smart price calendar', 'Lead inbox', 'Payout tracker', 'Fleet and staff ops', 'Growth signals'].map((item) => (
